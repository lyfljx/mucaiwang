...
<html>
    ...
    <body>
        ...
        <div class="div_head">
            <span>
                ...
                <span style="float:right;margin-right: 8px;font-weight: bold">
                    <a style="text-decoration: none" href="<?php echo ($smarty["const"]["/mucaiwang/index.php/Admin/Goods"]); ?>/showlist">【返回】</a>
                </span>
            </span>
        </div>
        <div></div>
        ...
        <div style="font-size: 13px;margin: 10px 5px">
            <form action="<?php echo ($smarty["const"]["/mucaiwang/index.php/Admin/Goods/xiugai"]); ?>" method="post" enctype="multipart/form-data">
