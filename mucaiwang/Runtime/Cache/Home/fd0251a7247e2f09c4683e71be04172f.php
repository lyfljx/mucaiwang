...
<div class="div_head">
			...
			<span style="float:right;margin-right: 8px;font-weight: bold">
                    <a style="text-decoration: none" href="/mucaiwang//index.php/Home/Pro/showlist">【返回】</a>
                </span>
			</span>
</div>
<div></div>
...
<div style="font-size: 13px;margin: 10px 5px">
    <form action="/mucaiwang//index.php/Pro/xiugai/pro_id/1.html" method="post" enctype="multipart/form-data">
        <!--因为要用到save()方法来指定要修改的数据，
        所以要用id值来指定是哪一条数据，提交时会连同修改记录提交过去-->
        <input type="hidden" name="pro_id" value="<?php echo ($info["pro_id"]); ?>" />
        <table border="1" cellspacing="0" cellpadding="0" width="80%" class="table_a">
            <tr>
                <td>产品名称</td>
