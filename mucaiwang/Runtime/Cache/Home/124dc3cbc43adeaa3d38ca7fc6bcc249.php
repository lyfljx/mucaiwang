...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type = "text/javascript">
			var verifyURL = '<?php echo U("Home/User/verify",'','');?>';
		</script>
	...
	<body>
		...
		<div class="login">	
			<form action="<?php echo U('Home/User/loginHandle');?>" method="post" id="login">
			<div class="title">
				用户 登录
			</div>
			<table border="1" width="100%">
				...
				<tr>
					<th>验证码:</th>
					<td>
				 		<input type="code" class="len250" name="code"/> <img src="<?php echo U('Home/User/verify');?>"  id="code"/><a href="javascript:void(change_code(this));">看不清</a> 
					</td>
				</tr>
				<tr>
