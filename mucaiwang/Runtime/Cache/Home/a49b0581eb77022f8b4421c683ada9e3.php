...
<table  border="1px solid " cellpadding="2" cellspacing="0" >
    <tr>
      ...
      <?php if(is_array($buy)): foreach($buy as $key=>$v): ?><tr>
           ...
           <td align="center" bgcolor="#7fffd4"><a href="<?php echo U('Home/Buy/offer',array('pid'=>$v['pur_id']));?>"><?php if($v['audit2']==1): ?>查看<?php endif; ?></a><?php if($v['audit2']!=1): ?>暂无<?php endif; ?></td>
           <td align="center">&nbsp;<a href="<?php echo U('Home/Buy/altBuy',array('pid'=>$v['pur_id']));?>">修改</a></td>
