            ...
            <table width="756" height="470" cellpadding="0" cellspacing="0" align="center">
                ...
                <tr>
                    <td valign="top" align="ceneter" class="border">
                        <form action="<?php echo U('Home/Offer/buy_order');?>" method="post"
                            ...
                            <table style="line-height: 27px" width="80%">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="size" name="offer_p_size"
                                               required="required"/></td>
                                </tr>
                                <!--<tr>-->
                                <!--<td align="right">分类：&nbsp;</td>-->
                                <!--<td><input type="text" name="offer_buy_pro_class" placeholder=""-->
                                <!--required="required"/>-->
                                <!--</td>-->
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="size" name="offer_origin_place"
                                               required="required" placeholder="广东-深圳"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right">(当前)所在地：</td>
                                    <td><input type="text" class="size" name="offer_local_place"
                                               required="required" placeholder="广东-深圳"/>
                                ...
                                <tr>
                                    <td align="right">父分类：
                                        ...
                                        <select name="offer_pro_pclass_id">
                                            <option value="0" selected="selected">--请选择--</option>
                                            <?php if(is_array($pclass)): foreach($pclass as $k=>$v): ?><option value=" <?php echo ($v["pro_pclass_id"]); ?>">
                                                    <?php echo ($v["pro_pclass"]); ?>
                                                </option><?php endforeach; endif; ?>
                                        </select>
                                    </td>
                                    <td align="center">子分类：
                                        <select name="offer_pro_class_id">
                                            <option value="0" selected="selected">--请选择--</option>
                                            <?php if(is_array($class)): foreach($class as $kk=>$vv): ?><option value="<?php echo ($vv["pro_class_id"]); ?>">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="size" name="offer_cut_time"
                                               placeholder="如：2006-01-01"
                                               required="required"/></td>

                                </tr>
                                <tr>
                                    <td align="right" valign="top">产品描述：</td>
                                    <td height="40"><textarea rows="10" cols="10" class="big"
