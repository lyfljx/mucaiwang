...
<body>
<!--<h2>报价</h2>-->
<form action="<?php echo U('Home/Offer/alterOffer',array(offer_id => $info['offer_id']));?>" method="post"
      enctype="multipart/form-data">
    <!--<form action="/mucaiwang//index.php/Home/Offer/alterOffer/offer_id/49" method="post">-->
    <table width="70%" border="1" cellpadding="5" cellspacing="0" bgcolor="#cccccc">

        <td><input type="hidden" name="offer_create_time" value="<?php echo ($info["offer_create_time"]); ?>"></td>
        ...
        <tr>
            ...
            <td><input type="text" name="offer_pro_name" placeholder="" value="<?php echo ($info["offer_pro_name"]); ?>"/></td>

        </tr>
        <tr>
            <td align="right">产品规格：&nbsp;</td>
            <td><input type="text" name="offer_p_size" placeholder="" value="<?php echo ($info["offer_p_size"]); ?>"/></td>

        </tr>
        <tr>
            <td align="right">产品价格：&nbsp;</td>
            <td><input type="text" name="offer_price" placeholder="" value="<?php echo ($info["offer_price"]); ?>"/></td>
        ...
        <tr>
            ...
            <td><textarea name="offer_description"><?php echo ($info["offer_description"]); ?></textarea>
