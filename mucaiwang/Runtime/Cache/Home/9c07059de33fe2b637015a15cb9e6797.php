...
<table width="100%" height="470" cellpadding="0" cellspacing="0" align="center">
    <tr>
        <td width="756" height="30" valign="middle" align="center" colspan="2" class="sell-title">
            <span><?php echo ($info["offer_pro_name"]); ?>价格行情</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <td valign="top" style="width: 560px;">
            <table height="300" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td align="left"><?php echo ($info["offer_pro_class"]); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><?php echo ($info["offer_origin_place"]); ?></td>
                </tr>
                <tr>
                ...
                <tr bgcolor="#f7f7f7">
                    ...
                    <td>
                        ...
                        <?php if(session('home_id') != 0): ?><form action="<?php echo U('Home/Buy/buy_order');?>" method="post">
                ...
                <tr>
                    ...
                    <td>
                        <?php if(session('home_id') != 0 ): echo ($info["offer_com"]); endif; ?>
