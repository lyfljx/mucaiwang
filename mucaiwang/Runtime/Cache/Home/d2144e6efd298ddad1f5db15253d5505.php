...
<table  border="1px solid " cellpadding="2" cellspacing="0" >
    <tr>
      ...
      <?php if(is_array($pur)): foreach($pur as $key=>$v): ?><tr>
           <td align="center" bgcolor="#7fffd4"><?php echo ($v["pur_id"]); ?></td>
           <td align="center"><?php echo ($v["pur_good_rname"]); ?></td>
           <td align="center" bgcolor="#7fffd4"><?php echo ($v["pur_class"]); ?></td>
           ...
           <td align="center" bgcolor="#7fffd4"><?php echo ($v["effective_time"]); ?></td>
           ...
           <td align="center" bgcolor="#7fffd4"><?php if($v['off']==1): ?><a href="<?php echo U('Home/Buy/buyer',array('uid'=>$v['pur_user_id'],'pid'=>$v['pur_id']));?>"><?php echo ($v["pur_user_name"]); ?></a><?php endif; ?></td>
