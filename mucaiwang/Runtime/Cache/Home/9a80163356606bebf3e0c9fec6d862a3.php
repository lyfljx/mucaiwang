            ...
            <table width="756" height="470" cellpadding="0" cellspacing="0" align="center">
                ...
                <tr>
                    <td valign="top" align="ceneter" class="border">
                        <form action="<?php echo U('Home/Buy/buy',array(offer_id => $offerS['offer_id']));?>" method="post" enctype="multipart/form-data">
                            <table style="line-height: 27px" width="80%">
                                <!--做隐藏域，传递用户id，方便在后台展示-->
                                <input type="hidden" class="size" name="offer_buyer_id"
                                       value="<?php echo (session('home_id')); ?>"/>
                                <input type="hidden" class="size" name="offer_buy_create_time"
                                       value="<?php echo time(); ?>"/>
                                ...
                                <tr>
                                    ...
                                    <td width="300" height="20"><input type="text" class="size" name="offer_buy_pro_name"
                                                                       required="required"/></td>
                                </tr>
                                <tr>
                                    <td align="right">产品价格:</td>
                                    <td><input type="text" class="size" name="offer_buy_pro_price"
                                               required="required"/></td>

                                </tr>
                                <tr>
                                    <td align="right">产品规格：</td>
                                    <td><input type="text" class="size" name="offer_buy_pro_p_size" required="required"/></td>
                                </tr>
                                <tr>
                                    <td align="right">分类：&nbsp;</td>
                                    <td><input type="text" name="offer_buy_pro_class" placeholder="" required="required"/>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="size" name="offer_buy_pro_origin_place" required="required"/>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <?php if(is_array($pclass)): foreach($pclass as $k=>$v): ?><option  name="pro_pclass">
                              ...
                              <select>
                                <option value="0" selected="selected">--请选择--</option>
                                <?php if(is_array($class)): foreach($class as $kk=>$vv): ?><option  name="pro_class">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="size" name="offer_buy_pro_cut_time" placeholder="如：2006-01-01"
                                               required="required"/></td>

                                </tr>
                                <tr>
                                    <td align="right" valign="top">产品描述：</td>
                                    <td height="40"><textarea rows="10" cols="10" class="big" name="offer_buy_description"
